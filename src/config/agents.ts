...
export const AGENT_GOAL_CONFIGS: Record<AgentGoal, AgentGoalConfig> = {
  ...
  competitor_intel: {
    ...
    description:
      "Tracks direct competitors and the whole-product ecosystem (augmenting tools like Claude Code, Cursor, GitHub Copilot, Codex, Gemini; context retrieval tools; and direct competitors like Augment Code, Moderne, OpenGrok, GitHub MCP).",
    primaryCategories: ["product_news", "tech_articles", "community"],
    icpDescription: ICP_DEFAULT,
    timeHorizonDays: 14,
    retrievalStrategies: {
      postgresWeight: 0.5,
    ...
    webQueryTemplates: [
      "Augment Code release",
      "Moderne code search",
      "Moderne code transformation",
      "OpenGrok alternative",
