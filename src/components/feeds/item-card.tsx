         ...
         <div className="flex-1 min-w-0">
          ...
          <div className="flex flex-wrap items-center gap-2 text-xs text-muted mb-2">
            <div className="flex items-center gap-1">
              ...
              <a
                href="/admin"
                className="inline-block px-1.5 py-0.5 rounded text-xs bg-gray-100 border border-gray-300 text-gray-600 hover:text-gray-900 hover:border-gray-400 transition-colors"
